...
#### 1. Dynamic Bond Pricing (Company Performance Index - CPI)
...
#### 2. Fractional Ownership via Tokenization
...
#### 6. Incentivized Corporate Bonds
...
The current implementation contains the basic wireframe of how the platform should look. [Click here to view the current prototype](https://bondx.framer.website/).
